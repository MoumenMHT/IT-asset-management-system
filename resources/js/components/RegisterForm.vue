...
<div class="wrapper">
    ...
    <form @submit.prevent="submitForm">
        ...
        <div class="input-box">
            <input type="text" v-model="form.password" placeholder="Password" required />
        </div>
        <div class="input-box">
            <input type="text" v-model="form.type" placeholder="Type" required />
        </div>
        
        <div class="policy">
            <a href="/"><h3>Already have an acount?</h3></a>
        </div>
